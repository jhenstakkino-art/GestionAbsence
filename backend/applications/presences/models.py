...
class PresenceProf(models.Model):
    professeur_pp = models.ForeignKey( Professeur,on_delete=models.SET_NULL, null=True, blank=True, related_name= 'pps')
...
class PresenceDelegue(models.Model):
    delegue_pd = models.ForeignKey(Delegue, on_delete=models.SET_NULL, null=True, blank=True, related_name= 'pds')
